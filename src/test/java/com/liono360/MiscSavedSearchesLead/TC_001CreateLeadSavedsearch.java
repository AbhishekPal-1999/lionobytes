...
public class TC_001CreateLeadSavedsearch extends Baseclass{

	@Test
	public void TC001_CreateLeadSavedsearch() throws InterruptedException {
		...
		ss.Name().sendKeys("SAVED SEARCH SS-"+randomnumber()+" Lead");
		...
		TrySelectDropdown( ss.SelectModule(),"Lead");
