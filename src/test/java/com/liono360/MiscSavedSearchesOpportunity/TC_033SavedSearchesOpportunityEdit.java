...
public class TC_033SavedSearchesOpportunityEdit extends Baseclass {

	@Test
	public void SavedSearchesOpportunityEditTest () throws InterruptedException {
		...
		Search.Name().sendKeys("FNamem1" + randomnumber());
