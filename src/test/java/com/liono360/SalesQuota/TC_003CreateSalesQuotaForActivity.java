...
public class TC_003CreateSalesQuotaForActivity extends Baseclass {

	
	@Test
	public void CreateSalesQuotaForActivityTest () throws InterruptedException, IOException {
		...
		SelectDropdown(SQ.Module(),2);
		logger.info("Select Module");
