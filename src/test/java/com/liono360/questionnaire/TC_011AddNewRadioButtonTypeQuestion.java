...
public class TC_011AddNewRadioButtonTypeQuestion extends Baseclass  {

	@Test
	public void TC_011AddNewRadioButtonTypeQuestionTest() throws InterruptedException, IOException, TimeoutException {
	    ...
	    Q.setQuestionName().sendKeys("select radio button for Question"+randomnumber());
	    String QuestionName=Q.setQuestionName().getAttribute("value");
	    logger.info("question name added");
	    
	    TryClick(Q.selectAnswerType());
	    driver.findElement(By.xpath("//span[text()='RadioButton']")).click();                            
		...
		Q.inputBox1().sendKeys("male");
		Q.inputBox2().sendKeys("female");
