...
public class TC_013CreatedWithSavedSearchWorkflowACNumber extends Baseclass{
	String wfname=null;
	
	@Test
	public void CreatedWithSavedSearchWorkflow() throws InterruptedException {
		redirectToCRM();
		...
		Thread.sleep(2000);
		logger.info("click add rule");
		workflow.clickCreatedSavedSearch().click();
	
		Thread.sleep(2000);
		logger.info("click created saved search");
		...
		Thread.sleep(10000);
			...
			workflow.AccountName().sendKeys("Wrkflowaccount"+randomnumber());
			logger.info("sendkeys on accountname");
			Thread.sleep(4000);
             String acname=workflow.AccountName().getAttribute("value");
			
			workflow.clickAccountAcNo().click();
			logger.info("click ccount no");
			Thread.sleep(1000);
			workflow.clickAccountAcNo().sendKeys("230792791655");
			...
			Thread.sleep(5000);
			Thread.sleep(2000); workflow.clickWorklowlist().click();
			...
			workflow.clickButtonemailAlert().click(); Thread.sleep(2000);
			logger.info("click Email alert");

			workflow.clickRefresh().click(); Thread.sleep(3000);
			...
			logger.info("click  history"); workflow.clickRefresh().click();
			Thread.sleep(3000); logger.info("click Refresh");
			workflow.clickHistory().click(); Thread.sleep(60000);
