...
public class TC_024SavedSearchesOwenerShipType extends Baseclass{
	@Test
	public void SavedSearchesOwenerShipTypeTest () throws InterruptedException, IOException {
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Ownership Type']")));
	    ...
	    Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' General Partnerships ']")));
		driver.findElement(By.xpath("//span[text()=' General Partnerships ']")).click();
		Search.Avalue1().click();
		logger.info("select on dropdown");
...
//................................................4....................................................//	
		...
		Thread.sleep(5000);
		Search.Ownership().click();
		logger.info("Clicked on Ownership button");
...
//.................................!!!!!!!!!!new1!!!!!!!!!!....................................................................//
		 ...
		 * 
		 * 
		 * Thread.sleep(5000); Search.Ownership().click();
		 * logger.info("Clicked on Ownership button");
		 * 
		 ...
		 * explWaitToClick(driver.findElement(By.
		 * xpath("//span[text()=' General Partnerships ']")));
		 * driver.findElement(By.xpath("//span[text()=' General Partnerships ']")).click
		 * (); logger.info("select on dropdown");
		 * 
		 * 
