...
public class TC_036SavedSearchesZipPostalCode extends Baseclass {

	@Test
	public void SavedSearchesZipPostalCodeTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Thread.sleep(5000);
		// explWaitToClick(account.Operator());
		Search.Avalue2().sendKeys("221311");
