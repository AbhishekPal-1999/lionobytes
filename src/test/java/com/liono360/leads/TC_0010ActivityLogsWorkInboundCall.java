...
public class TC_0010ActivityLogsWorkInboundCall extends Baseclass{
	
	@Test
	public void TC0010_ActivityLogsWorkInboundCall() throws InterruptedException, IOException {
		//redirectToCRM();
...
// Activity Work Inbounds Call====================================================================================================		
		...
		logger.info("Work Log type Selected");
		
		
		Thread.sleep(2000);
		logger.info("Selected Logs SubType is "+leads.SubTypes().getText());
		
		leads.Add_Comments().sendKeys("This comment represent the Work");
		logger.info("Comment is added under Work log type");
		
		TryClick(leads.clickSave());
		logger.info("Clicked on Save button");

// Edit Work Inbounds Call========================================================================================================
		...
		leads.Add_Comments().sendKeys("This comment represent the Updated Work");
		logger.info("Comment is Updated under Mobile log type");
				
		leads.Edit_Add_Comments().sendKeys("This comment represent the new comment while edit Work");
		logger.info("New Comment is added under for Work");
				
		TryClick(leads.SaveAllDetails());
		logger.info("Clicked on Save button");

//Delete Work Inbounds Call============================================================================================
		waitUntilPageLoad();
		Thread.sleep(1000);
