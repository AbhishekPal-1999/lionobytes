...
public class TC_025CreatedWithUpdatedMultipleConditionWorkflow  extends Baseclass{
	String wfname=null;
	@Test
	
	public void CreatedWithUpdatedMultipleConditionWorkflow() throws Exception {
		redirectToCRM();
	...
	Thread.sleep(1000);
		...
		Thread.sleep(3000);
		logger.info("click Executed list");
