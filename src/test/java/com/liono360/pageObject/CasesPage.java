...
public class CasesPage extends com.liono360.loginPage.Baseclass{
	...
	@FindBy(xpath="//p-autocomplete[@formcontrolname=\"associationName\"]")
	WebElement OrgSearchbyname;
	
	public WebElement setAssociationNameOrg() {
		return OrgSearchbyname;
	}
	
	

	@FindBy(xpath="//ul[@role=\"listbox\"]")
	WebElement SelectAssocation;
	
	public WebElement SelecttheAssocation() {
		return SelectAssocation;
	}
	...
	@FindBy(xpath="(//div[@role=\"dialog\"]//tr//td)[1]")
	WebElement CaseAssociationSelection;
	
	public WebElement CaseAssociationSelect() {
		return CaseAssociationSelection;
	}
	...
	@FindBy(xpath="(//a[@target=\"undefined\"]//span[@data-pc-section=\"icon\"])[7]")
	...
	@FindBy(xpath="//span[@aria-label=\"Select User\"]")
