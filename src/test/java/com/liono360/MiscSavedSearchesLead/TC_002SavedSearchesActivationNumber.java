...
public class TC_002SavedSearchesActivationNumber extends Baseclass{

	@Test
	public void SavedSearchesActivationNumberTest () throws InterruptedException {
		driver.get(baseURL);
