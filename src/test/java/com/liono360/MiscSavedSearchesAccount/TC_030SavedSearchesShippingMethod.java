...
public class TC_030SavedSearchesShippingMethod extends Baseclass{

	@Test
	public void SavedSearchesShippingMethodTest () throws InterruptedException, IOException {
		driver.get(baseURL);
		...
		driver.manage().timeouts().implicitlyWait(50,TimeUnit.SECONDS);
		  ...
		  Search.Name().sendKeys("FNamej1" +randomnumber()); 
		  ...
		  Search.Filter().click(); 
		  Thread.sleep(2000);
		  explWaitToClick(driver.findElement(By.xpath("//span[text()='Shipping Method']")));
	...
	//................................................4....................................................//	
			...
			Thread.sleep(5000);
			Search.ShippingMethod().click();
			logger.info("Clicked on ShippingMethod button");
			
			
			
			Thread.sleep(5000);
			Search.StreetAdress1().click();
			logger.info("Clicked on StreetAdress1 button");
	...
	//		logger.info("Clicked on Xcross button");
		...
		//  ..................................................//
			 ...
			 * xpath("//span[text()='Street Address 1']")));
			 ...
			 * 
			 * Thread.sleep(5000); //explWaitToClick(account.Operator());
			 * Search.Avalue2().sendKeys("23 St"); logger.info("sendkeys on Avalue1");
			 * 
			 * //........................................END................................
			 * // ..............................// //..................................ADM
			 * // New...........................................................//
			 ...
			 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Work Phone']")));
			 * driver.findElement(By.xpath("//span[text()='Work Phone']")).click();
			 * logger.info("select on dropdown");
			 * 
			 * Thread.sleep(3000); //explWaitToClick(account.Operator());
			 ...
			 * 
			 * 
			 * Thread.sleep(5000); Search.ShippingMethod().click();
			 * logger.info("Clicked on ShippingMethod button");
			 * 
			 * 
			 * 
			 * Thread.sleep(5000); Search.StreetAdress1().click();
			 * logger.info("Clicked on StreetAdress1 button");
			 * 
			 * 
			 ...
			 * 
			 * Thread.sleep(5000); //explWaitToClick(account.Operator());
			 * Search.ADMoperator().click(); Thread.sleep(3000);
			 * explWaitToClick(driver.findElement(By.xpath("//span[text()='IsEqualTo']")));
			 * driver.findElement(By.xpath("//span[text()='IsEqualTo']")).click();
			 * logger.info("select on dropdown");
			 * 
			 * 
			 * Thread.sleep(5000); Search.Avalue4().click(); Thread.sleep(3000);
			 * explWaitToClick(driver.findElement(By.xpath("//span[text()='India']")));
			 * driver.findElement(By.xpath("//span[text()='India']")).click();
			 * Search.Avalue4().click(); logger.info("select on dropdown");
			 * 
			 * Thread.sleep(5000); Search.ADMSave().click();
			 * logger.info("Clicked on ADMSave button");
			 * 
