...
public class TC_024SavedSearchesRadius extends Baseclass{

	@Test
	public void SavedSearchesRadiusTest () throws InterruptedException {
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Radius']")));
		driver.findElement(By.xpath("//span[text()='Radius']")).click();
		logger.info("select on dropdown");
		...
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Within']")));
		driver.findElement(By.xpath("//span[text()='Within']")).click();
		logger.info("select on dropdown");
		


	//	Thread.sleep(3000);
		//explWaitToClick(account.Value1());
		//Search.Value1().sendKeys("100");
		//logger.info("sendkeys on Value1 ");
		
		Thread.sleep(3000);
		//explWaitToClick(account.SelectAdress());
		Search.SelectAdress().click();
		logger.info("click on SelectAdress ");
       ...
       Actions action = new Actions(driver);
		...
		Thread.sleep(2000);
		Search.Location().sendKeys("10808 Culver Boulevard Park West");
		Thread.sleep(2000);
		...
		Thread.sleep(5000);
		Search.Radius().sendKeys("1");
		logger.info("Clicked on Radius button");
		
		Thread.sleep(5000);
		Search.SelectRadiusAdress().click();
		logger.info("Clicked on SelectRadiusAdress button");
		...
		Thread.sleep(5000);
		Search.Save3().click();
		logger.info("Clicked on Save3 button");
		
		
		Thread.sleep(5000);
		Search.RadiusSave().click();
		logger.info("Clicked on RadiusSave button");
		...
		Search.Operator().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Outside']")));
		driver.findElement(By.xpath("//span[text()='Outside']")).click();
		logger.info("select on dropdown");
	...
	//	Thread.sleep(3000);
		...
		Thread.sleep(5000);
		Search.Radius1().click();
		logger.info("Clicked on Radius1 button");
