...
public class TC_040SavedSearchesZipPostalCode extends Baseclass {

	@Test
	public void SavedSearchesZipPostalCodeTest () throws InterruptedException, IOException {
		...
		driver.manage().timeouts().implicitlyWait(50,TimeUnit.SECONDS);
		  ...
		  Search.Name().sendKeys("FNameo4" +randomnumber()); 
		  ...
		  Search.Filter().click();
		  Thread.sleep(2000);
		  explWaitToClick(driver.findElement(By. xpath("//span[text()='Zip/Postal Code']")));
		  ...
		  Search.Avalue2().sendKeys("45678"); 
		  logger.info("sendkeys on Avalue1");
	...
	//................................................7....................................................//	
	 ...
	 //................................................8....................................................//
			...
			Thread.sleep(5000);
			Search.Zippostalcode().click();
			logger.info("Clicked on Zippostalcode button");
			
			
			Thread.sleep(5000);
			Search.Siccode().click();
			logger.info("Clicked on Siccode button");
		...
		//	logger.info("Clicked on Xcross button");
		  ...
		  //..................................................//
			 ...
			 * explWaitToClick(driver.findElement(By.xpath("(//span[text()='1XR'])[2]")));
			 ...
			 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Job Function']"))
			 * ); driver.findElement(By.xpath("//span[text()='Job Function']")).click();
			 * logger.info("select on dropdown");
			 * 
			 * Thread.sleep(3000); //explWaitToClick(account.Operator());
			 ...
			 * 
			 * 
			 * Thread.sleep(5000); Search.Zippostalcode().click();
			 * logger.info("Clicked on Zippostalcode button");
			 * 
			 * 
			 ...
			 * explWaitToClick(driver.findElement(By.
			 * xpath("//span[text()='Zip/Postal Code']")));
			 * driver.findElement(By.xpath("//span[text()='Zip/Postal Code']")).click();
			 * logger.info("select on dropdown");
			 * 
			 * Thread.sleep(3000); //explWaitToClick(account.Operator());
			 ...
			 * 
			 * //Thread.sleep(5000); //explWaitToClick(account.Operator());
			 * //Search.Avalue2().sendKeys("45678"); //logger.info("sendkeys on Avalue1");
			 * 
			 * 
			 * //.................................!!!!!!!!!!new1!!!!!!!!!!..................
			 * ..................................................// Thread.sleep(5000);
			 ...
			 * 
			 * 
			 * Thread.sleep(5000); Search.Siccode().click();
			 * logger.info("Clicked on Siccode button");
			 * 
			 * Thread.sleep(5000); Search.SettingSave().click();
			 * logger.info("Clicked on SettingSave button");
