...
public class TC_031SavedSearchesStreetAddress2 extends Baseclass {

	@Test
	public void SavedSearchesStreetAddress2Test () throws InterruptedException {
		...
		Search.Name().sendKeys("FName8h" + randomnumber());
