...
public class TC_059CreateEventBasedWorkFlow_Created_ManualMultipleRuleAndSaveSearch extends Baseclass {

	@Test
	public void TC_054CreateEventBasedWorkFlow_Created_SingleSaveSearchTest() throws InterruptedException, IOException, TimeoutException {
...
//CREATE WORK FLOW ----------------------------------------------------------------------------------------------	    
		...
		workflow.setName().sendKeys("WorkFlow"+randomnumber()+"SingleSaveSearch");
...
// ADD SAVE SEARCH CONDITOON HERE------------------------------------------------------------------------------------
	    ...
	    Thread.sleep(6000);
	    driver.findElement(By.xpath("//div[text()=' TestingSaveSearchDoNotEditDelete ']")).click();
...
// ASSERTION--------------------------------------------------------------------------------------------------------
	   ...
	   if (WorkflowNameToCreate.equals(WorkflowNameAfterCreate)&&CheckActionStatusInCreatedLead&&ActionStatusInHistory&&ActionStatusInCreatedLead) {
