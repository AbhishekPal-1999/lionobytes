...
public class TC_046CreateTimeBasedWorkFlow_LeadNumber extends Baseclass {

	@Test
	public void TC_046CreateTimeBasedWorkFlow_LeadNumberTest() throws InterruptedException, IOException {
...
//CREATE WORK FLOW ----------------------------------------------------------------------------------------------	    
	    ...
	    workflow.setTimeBasedValue().sendKeys("60");
...
// VERIFY THAT WORKFLOW CREATED AND WORKING FINE OR NOT---------------------------------------------------
	    ...
	    commonMethods.GotoExistingLeadAndEdit(existingLeads);
	    commonMethods.CreateLead(ruleValue);
