...
public class TC_033SavedSearchesTimezones extends Baseclass{

	@Test
	public void SavedSearchesTimezonesTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Name().sendKeys("FNameY6" + randomnumber());
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Time  zone']")));
		...
		Search.Value().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' (GMT+01:00) Amsterdam ']")));
		driver.findElement(By.xpath("//span[text()=' (GMT+01:00) Amsterdam ']")).click();
		Search.Value().click();
		logger.info("select on dropdown");
...
//................................................4....................................................//	
		...
		Thread.sleep(5000);
		Search.LeadTimezone().click();
		logger.info("Clicked on LeadTimezone button");
