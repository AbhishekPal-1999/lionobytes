...
public class TC_001CreateAccountsToTerritory extends Baseclass{
	...
	public void CreateAccountsToTerritoryTest () throws InterruptedException {
		...
		//Thread.sleep(2000);
		//account.Firstname().sendKeys("Sanket");
		//logger.info("Sendkeys on firstname");
		
		
		//Thread.sleep(2000);
		//account.middlename().sendKeys("Vishal");
		//logger.info("Sendkeys on middlename");
		
		//Thread.sleep(2000);
		//account.Latname().sendKeys("Shirole");
		//logger.info("Sendkeys on middlename");
		...
		account.Phone1().sendKeys("8788526" + randomnumber());
		logger.info("Sendkeys on phone1");
		
		Thread.sleep(5000);
		//explWaitToClick(account.JobFun());
		account.JobFun().click();
		Thread.sleep(2000);
		...
		/*
		 * Thread.sleep(2000); account.ParentName().click(); Thread.sleep(2000);
		 * explWaitToClick(driver.findElement(By.xpath("(//span[text()='1111'])[1]")));
		 * driver.findElement(By.xpath("(//span[text()='1111'])[1]")).click();
		 * logger.info("select on dropdown");
		 */
	...
	//	Thread.sleep(2000);
	//	explWaitToClick(driver.findElement(By.xpath("//span[text()='News']")));
