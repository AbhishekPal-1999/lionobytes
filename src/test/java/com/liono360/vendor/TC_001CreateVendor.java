...
public class TC_001CreateVendor extends Baseclass {
	...
	public void CreateVendor() throws InterruptedException, IOException {
		...
		String setclickVendorName = vendor.clickVendorName().getAttribute("value");
		  ...
		  vendor.clickVendorType().click(); logger.info("click vendor select type ");
		  // Thread.sleep(1000);
		  
		  vendor.clickselectvendortype().click(); logger.info("click vendor ");
		  Thread.sleep(1000);
		...
		logger.info("click language selection");
