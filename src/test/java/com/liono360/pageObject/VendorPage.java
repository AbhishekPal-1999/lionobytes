...
public class VendorPage extends Baseclass {
	...
	@FindBy(xpath = "//p-multiselect[@placeholder='Select Vendor Type']")
	...
	@FindBy(xpath = "//li[@aria-label='Manufacturer']")
	WebElement btnselectVendorType;
	...
	@FindBy(xpath="//span[text()='View Vendor']")
	WebElement hdrViewVendor;
	
	public WebElement ViewVendorPrompt() {
		return hdrViewVendor;
	}
