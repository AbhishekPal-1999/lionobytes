...
public class SalesPage extends Baseclass{
	...
	@FindBy(xpath="//span[normalize-space()='Pack']")
	WebElement btnPack;
	...
	@FindBy(xpath="//span[normalize-space()='Ship']") 
	WebElement btnShip;
	...
	public WebElement clickReadyToShip() {
		return clickReadyToShip;
	}
	@FindBy(xpath="//span[text()='ReadyToShip']")
	WebElement clickReadyToShip;
	public WebElement clickCopysales() {
		return clickCopyBtn;
	}
