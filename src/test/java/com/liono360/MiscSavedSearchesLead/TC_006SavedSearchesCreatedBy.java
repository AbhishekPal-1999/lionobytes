...
public class TC_006SavedSearchesCreatedBy extends Baseclass {

	@Test
	public void SavedSearchesCreatedByTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Name().sendKeys("FNamel8" + randomnumber());
