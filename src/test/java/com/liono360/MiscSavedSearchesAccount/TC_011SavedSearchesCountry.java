...
public class TC_011SavedSearchesCountry extends Baseclass{
	
	@Test
	public void SavedSearchesCountry () throws InterruptedException, IOException {
		...
		driver.manage().timeouts().implicitlyWait(50,TimeUnit.SECONDS);
		  ...
		  Search.Name().sendKeys("FName4c" +randomnumber()); 
		  ...
		  Search.Avalue9().click(); Thread.sleep(2000);
	...
	//............................Group 1.......................................................//	
		 ...
		 */
		 ...
		 // ..................................................// Thread.sleep(5000);
			 ...
			 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Timezone']")));
			 ...
			 * explWaitToClick(driver.findElement(By.
			 * xpath("//span[text()=' (GMT) Casablanca ']")));
			 * driver.findElement(By.xpath("//span[text()=' (GMT) Casablanca ']")).click();
			 ...
			 * 
			 * 
			 * Thread.sleep(7000); Search.Xcross().click();
			 * logger.info("Clicked on Xcross button");
			 * 
			 * 
			 * 
