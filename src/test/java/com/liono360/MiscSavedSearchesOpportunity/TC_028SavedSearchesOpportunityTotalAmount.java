...
public class TC_028SavedSearchesOpportunityTotalAmount extends Baseclass{

	@Test
	public void SavedSearchesOpportunityTotalAmountTest () throws InterruptedException {
		...
		Search.Name().sendKeys("BName4" + randomnumber());
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Total Amount']")));
		driver.findElement(By.xpath("//span[text()='Total Amount']")).click();
		logger.info("select on dropdown");
		...
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='IsGreaterThan']")));
		driver.findElement(By.xpath("//span[text()='IsGreaterThan']")).click();
		logger.info("select on dropdown");
		
		
		Thread.sleep(5000);
		Search.Value1().sendKeys("2400");
		...
		Search.Operator().click();
	    Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='IsLessThan']")));
		driver.findElement(By.xpath("//span[text()='IsLessThan']")).click();
		logger.info("select on dropdown");
    ...
    //................................................4....................................................//		
		...
		Search.Operator().click();
	    Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='IsGreaterThanEqualTo']")));
		driver.findElement(By.xpath("//span[text()='IsGreaterThanEqualTo']")).click();
		logger.info("select on dropdown");
 ...
 //................................................6....................................................//	
		...
		Search.Operator().click();
	    Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='NotBetween']")));
		driver.findElement(By.xpath("//span[text()='NotBetween']")).click();
		logger.info("select on dropdown");
		
		

		Thread.sleep(5000);
		Search.Value1().sendKeys("100");
		logger.info("Clicked on Value1 button");
		
		
		
	//	Thread.sleep(5000);
	//	Search.Value120().sendKeys("-100");
	//	logger.info("Clicked on Value1 button");
...
//................................................7....................................................//	
		...
		Search.Operator().click();
	    Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='IsLessThanEqualTo']")));
		driver.findElement(By.xpath("//span[text()='IsLessThanEqualTo']")).click();
		logger.info("select on dropdown");
 ...
 //................................................8....................................................//
		...
		Thread.sleep(5000);
		Search.TotalAmount().click();
		logger.info("Clicked on TotalAmount button");
	...
	/*
	 * Thread.sleep(8000); Search.GroupC().click();
	 * logger.info("Clicked on GroupC button");
	 * 
	 * 
	 * 
	 * Thread.sleep(5000); //explWaitToClick(account.Operator());
	 * Search.GroupBy().click(); Thread.sleep(2000);
	 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Quality']")));
	 * driver.findElement(By.xpath("//span[text()='Quality']")).click();
	 * logger.info("select on dropdown");
	 * 
	 * 
	 * Thread.sleep(3000); // explWaitToClick(account.Operator());
	 * Search.AggregateFields().click(); Thread.sleep(2000);
	 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Item Total']")));
	 * driver.findElement(By.xpath("//span[text()='Item Total']")).click();
	 * Search.AggregateFields().click(); logger.info("select on dropdown");
	 * 
	 * Thread.sleep(3000); // explWaitToClick(account.Operator());
	 * Search.AggregateType().click(); Thread.sleep(2000);
	 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Total']")));
	 * driver.findElement(By.xpath("//span[text()='Total']")).click();
	 * logger.info("select on dropdown");
	 * 
	 * Thread.sleep(5000); Search.GSave().click();
