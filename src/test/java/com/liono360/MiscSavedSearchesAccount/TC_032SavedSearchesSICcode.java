...
public class TC_032SavedSearchesSICcode extends Baseclass{
	@Test
	public void SavedSearchesSICcodeTest () throws InterruptedException, IOException {
		...
		Search.Name().sendKeys("FNamel7o" + randomnumber());
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='SIC Code']")));
		...
		Thread.sleep(5000);
		//explWaitToClick(account.Operator());
		Search.Avalue2().sendKeys("213234535");
		logger.info("sendkeys on Avalue2");
...
//.................................!!!!!!!!!!new1!!!!!!!!!!....................................................................//
		 ...
		 * 
		 * 
		 * Thread.sleep(5000); Search.Avalue15().click(); Thread.sleep(3000);
		 ...
		 * 
		 * 
		 * Thread.sleep(9000); Search.ADMSave().click();
		 * logger.info("Clicked on ADMSave button");
		 * 
		 * 
		 * Thread.sleep(5000); Search.Preview().click();
