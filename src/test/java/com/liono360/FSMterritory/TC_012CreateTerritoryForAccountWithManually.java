...
public class TC_012CreateTerritoryForAccountWithManually extends Baseclass {
	
	List<String> list1=new ArrayList<String>();  
	@Test
	public void TC_0012CreateTerritoryForAccountsWithManually() throws InterruptedException, IOException {
