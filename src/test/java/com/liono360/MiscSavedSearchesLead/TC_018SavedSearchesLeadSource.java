...
public class TC_018SavedSearchesLeadSource extends Baseclass{

	@Test
	public void SavedSearchesLeadSourceTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Name().sendKeys("FNamey4" + randomnumber());
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Lead Source']")));
...
//................................................4....................................................//	
		...
		logger.info("Clicked on Cancel button");
		  ...
		  Thread.sleep(5000); 
		  Search.LeadSource().click();
		  logger.info("Clicked on LeadSource button");
