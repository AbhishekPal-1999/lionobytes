...
public class TC_030SavedSearchesStreetAddress1 extends Baseclass{

	@Test
	public void SavedSearchesStreetAddress1Test () throws InterruptedException {
		...
		Search.Name().sendKeys("FName0k" + randomnumber());
