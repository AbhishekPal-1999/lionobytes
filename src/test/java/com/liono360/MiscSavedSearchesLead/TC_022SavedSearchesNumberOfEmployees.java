...
public class TC_022SavedSearchesNumberOfEmployees extends Baseclass {

	@Test
	public void SavedSearchesNumberOfEmployeesTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Name().sendKeys("FName2" + randomnumber());
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Number of Employees']")));
		...
		Search.Value().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' 11-50 ']")));
		driver.findElement(By.xpath("//span[text()=' 11-50 ']")).click();
		Search.Value().click();
		logger.info("select on dropdown");
	...
	//................................................4....................................................//	
			...
			Thread.sleep(5000); //explWaitToClick(account.Operator());
			  Search.Value().click(); Thread.sleep(2000);
			  explWaitToClick(driver.findElement(By.xpath("//span[text()=' 11-50 ']")));
			  driver.findElement(By.xpath("//span[text()=' 11-50 ']")).click();
			  Search.Value().click();
			  logger.info("select on dropdown");
			...
			Thread.sleep(5000);
			Search.NoofEmpLead().click();
			logger.info("Clicked on NoofEmpLead button");
