...
public class TC_019UpdateAppendOnLeads extends Baseclass{

	@Test
	public  void TC_019UpdateAppendOnLeadsTest () throws InterruptedException, FileNotFoundException, IOException {
		...
		Thread.sleep(5000);
		leads.clickeditLead().click();
		logger.info("edit lead button");
		
		
		Thread.sleep(5000);
		leads.LeadInformation().click();
		logger.info("Click on  lead Information btn");
