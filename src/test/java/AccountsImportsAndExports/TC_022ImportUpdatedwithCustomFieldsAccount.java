...
public class TC_022ImportUpdatedwithCustomFieldsAccount extends Baseclass {
	
	@Test
	public void ImportUpdatedwithCustomFieldsTest () throws InterruptedException, AWTException, FileNotFoundException, IOException {
		// redirectToCRM();
		...
		update1.UpdateWithCustomFileds();
