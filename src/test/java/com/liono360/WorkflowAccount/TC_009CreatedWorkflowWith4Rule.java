...
public class TC_009CreatedWorkflowWith4Rule extends Baseclass{
	String wfname=null;

	@Test
	public void CreatedWorkflowWith4Rule() throws InterruptedException {
		redirectToCRM();
	...
	//	Thread.sleep(4000);
		...
		Thread.sleep(1000);
		logger.info("click IsEqual operator");
		workflow.clickSelectcountryitem().click();
		//Thread.sleep(1000);
		logger.info("fill Value");
	//	 String country=workflow.clickSelectcountryitem().getAttribute("value");
		Thread.sleep(2000);
			...
			Thread.sleep(1000);
			 ...
			 workflow.clickAddRuleManual().click();
			  ...
			  workflow.clickSelectRuleFilter3().click();
				...
				Thread.sleep(1000);
				logger.info("click created date");
				driver.findElement(By.xpath("//span[text()='Between']")).click();
				
		
		logger.info("click select operator");
		Thread.sleep(500);
		driver.findElement(By.xpath("//li[@aria-label='Before']")).click();
		logger.info("click select brfore operator");
		Thread.sleep(500);
			workflow.clickDatePlaceholder().click();
			Thread.sleep(1000);
			logger.info("click Select  date placeholder");
			 LocalDate currentDate = LocalDate.now();
		        String dateValue = currentDate.toString();
		        Thread.sleep(1000);
		        // Find the input field and set the date value
		        WebElement dateInput = driver.findElement(By.xpath("//input[@placeholder='mm/dd/yyyy']"));
			...
			logger.info("click select iteem");
			  ...
			  String Currency=driver.findElement(By.xpath("(//div[contains(text(),'Select Items')])[1]")).getAttribute("value");
			
			Thread.sleep(1000);
			logger.info("click IsEqual operator");
			driver.findElement(By.xpath("(//li[@aria-label='Dollars'])[2]")).click();
		//	workflow.clickSelectcountryitem().click();
			Thread.sleep(1000);
		...
		//Create Account
		public void createAccount(String currency) throws InterruptedException {
			WorkFlowPage workflow = new WorkFlowPage(driver);
