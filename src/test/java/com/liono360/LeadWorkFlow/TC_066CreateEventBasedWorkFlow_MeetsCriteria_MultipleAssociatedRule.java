...
public class TC_066CreateEventBasedWorkFlow_MeetsCriteria_MultipleAssociatedRule extends Baseclass {
...
//CREATE WORK FLOW ----------------------------------------------------------------------------------------------	    
		...
		logger.info("created And EveryTime Edited meets criteria clicked");
	    Thread.sleep(2000);
