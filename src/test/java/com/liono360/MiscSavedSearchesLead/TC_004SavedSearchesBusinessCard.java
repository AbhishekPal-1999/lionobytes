...
public class TC_004SavedSearchesBusinessCard extends Baseclass{

	@Test
	public void SavedSearchesBusinessCardTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Business Card']")));
		driver.findElement(By.xpath("//span[text()='Business Card']")).click();
		logger.info("select on dropdown");
