...
public class TC_012CreateSubTerritoryWithManually_Account extends Baseclass {

	@Test
	public void TC_012CreateSubTerritoryWithManually_AccountTest() throws InterruptedException, IOException {
...
// ADD NEW ROOT TERRITORY=====================================================================================
		...
		territory.clickSaveTerritory().click();
		logger.info("Sub territory added");
