...
public class TC_017EditPermission extends Baseclass {

	@Test
	public void EditPermissionTest () throws InterruptedException {
		...
		user.ChannelDrp().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[normalize-space()='Akash_Automation']")));
		driver.findElement(By.xpath("//span[normalize-space()='Akash_Automation']")).click();
		logger.info("select on dropdown");
