...
public class TC_007CreatedWorkflowWithAccountNo extends Baseclass {
	String wfname=null;

	@Test
	public void CreatedWorkflowWithAccountNo() throws Exception {
		redirectToCRM();
		...
		workflow.clickAccountNo1().click();
		Thread.sleep(2000);
		logger.info("click Account No");
		...
		workflow.clickValueEnter().sendKeys("9876543" + randomnumber());
		Thread.sleep(1000);
	...
	public void createAccount(String account) throws InterruptedException {
		...
		Thread.sleep(1000);
		workflow.clickAccountAcNo().sendKeys(account);
