...
import ExcelWriteCodeImports.TC_004AddDataExcelFileOnAccount;

public class TC_019ImportAddWithDefaultFiledAccount extends Baseclass {
	@Test
	public void ImportTest() throws InterruptedException, AWTException, FileNotFoundException, IOException {
		// redirectToCRM();
		...
		Thread.sleep(5000);
		TC_004AddDataExcelFileOnAccount addaccount = new TC_004AddDataExcelFileOnAccount();
		addaccount.TryExcelFileWriteCodeTest();
		logger.info("Excel Data Write");

		Thread.sleep(4000);
		String filepath = System.getProperty("user.dir")
				+ "\\TestData\\Excel-Files-Accounts\\Account_Add Imports_With Default Fileds 1.1.xlsx";
		Thread.sleep(5000);
