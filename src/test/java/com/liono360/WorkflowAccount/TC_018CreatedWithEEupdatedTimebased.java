...
public class TC_018CreatedWithEEupdatedTimebased  extends Baseclass {
	String wfname=null;

	@Test
	public void CreatedWithEEupdatedTimebased() throws InterruptedException {
		redirectToCRM();
		 ...
		 WorkFlowPage workflow = new WorkFlowPage(driver);
			...
			workflow.AccountName().sendKeys("AccountNameSavedManual");
