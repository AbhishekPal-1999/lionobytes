...
public class TC_001SavedSearchesOpportunityAccountName extends Baseclass{
	
	@Test
	public void SavedSearchesOpportunity1XRTest () throws InterruptedException {
		...
		Search.Name().sendKeys("Na1meu5" + randomnumber());
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("(//span[text()='Account Name'])[2]")));
		driver.findElement(By.xpath("(//span[text()='Account Name'])[2]")).click();
		logger.info("select on dropdown");
		...
		Thread.sleep(5000);
		Search.Oppvalue().click();
		Thread.sleep(2000);
		action.sendKeys(Keys.ARROW_DOWN).build().perform();
		action.sendKeys(Keys.ENTER).build().perform();
		logger.info("Clicked on Oppvalue button");
