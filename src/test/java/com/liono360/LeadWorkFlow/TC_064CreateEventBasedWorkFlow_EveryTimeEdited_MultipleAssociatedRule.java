...
public class TC_064CreateEventBasedWorkFlow_EveryTimeEdited_MultipleAssociatedRule extends Baseclass {

	@Test
	public void TC_064CreateEventBasedWorkFlow_EveryTimeEdited_MultipleAssociatedRuleTest() throws InterruptedException, IOException {
...
//5.
		    ...
		    Thread.sleep(2000);
		    String title= driver.findElement(By.xpath("//ul[@role='listbox']//p-multiselectitem[1]//li")).getText();
		    Thread.sleep(500);
...
// CREATE A LEAD ACCORDING TO THIS RULE-----------------------------------------------------------
	    ...
	    driver.switchTo().window(tabs.get(1));
		Thread.sleep(400);
	    commonMethods.CreateNewLeadMultipleAssociatedRule2(MiddleInitial,Lastname,WorkEmail,title,HomeEmail,jobFunction);	    
	    driver.switchTo().window(tabs.get(0));
