...
public class TC_073CreateEventBasedWorkFlow_EveryTimeEdited_UpdateField extends Baseclass{

	@Test
	public void TC073_CreateEventBasedWorkFlow_EveryTimeEdited_UpdateField() throws InterruptedException, IOException {
...
// CREATE A LEAD ACCORDING TO THIS RULE-----------------------------------------------------------
	    ...
	    driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	    System.out.println("found existed lead is: "+existingLeads);
	    workflow.clickCancel2().click();
	    logger.info("cancel button clicked");
	    workflow.waitUntilPageLoad();
