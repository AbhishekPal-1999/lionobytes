...
public class TC_025SavedSearchesRating extends Baseclass{

	@Test
	public void SavedSearchesRatingTest () throws InterruptedException {
		...
		Search.Name().sendKeys("FName1g" + randomnumber());
		...
		Search.Value().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' Hot ']")));
		driver.findElement(By.xpath("//span[text()=' Hot ']")).click();
		Search.Value().click();
		logger.info("select on dropdown");
