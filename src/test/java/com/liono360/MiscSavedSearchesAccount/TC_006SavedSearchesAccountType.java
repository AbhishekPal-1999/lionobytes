...
public class TC_006SavedSearchesAccountType extends Baseclass{
	@Test
	public void SavedSearchesAccountTypeTest () throws InterruptedException, IOException {
		...
		Search.Name().sendKeys("FNameo5" + randomnumber());
	    ...
	    Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' Premium ']")));
...
//................................................4....................................................//	
		...
		Thread.sleep(5000);
		Search.AccountType().click();
		logger.info("Clicked on AccountType button");
...
//.................................!!!!!!!!!!new1!!!!!!!!!!....................................................................//
		 ...
		 * 
		 * 
		 * Thread.sleep(5000); Search.AccountType().click();
		 * logger.info("Clicked on AccountType button");
		 * 
		 * 
		 * Thread.sleep(5000); Search.Country().click();
		 * logger.info("Clicked on Country button");
		 * 
		 * 
		 ...
		 * explWaitToClick(driver.findElement(By.
		 * xpath("//span[text()='Account Type(s)']")));
		 * driver.findElement(By.xpath("//span[text()='Account Type(s)']")).click();
		 * logger.info("select on dropdown");
		 * 
		 * Thread.sleep(3000); //explWaitToClick(account.Operator());
		 ...
		 * Search.ADMFilter().click(); Thread.sleep(2000);
		 * explWaitToClick(driver.findElement(By.
		 * xpath("//span[text()='Territory Other Contact']")));
		 * driver.findElement(By.xpath("//span[text()='Territory Other Contact']")).
		 * click(); logger.info("select on dropdown");
		 * 
		 * Thread.sleep(3000); //explWaitToClick(account.Operator());
		 * Search.ADMoperator().click(); Thread.sleep(2000);
		 ...
		 * 
		 * Thread.sleep(5000); Search.ADMValue().click(); Thread.sleep(2000);
		 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Chaitra Shetty']"
		 * ))); driver.findElement(By.xpath("//span[text()='Chaitra Shetty']")).click();
		 * Search.ADMValue().click(); logger.info("select on dropdown");
		 * 
		 * 
		 * Thread.sleep(5000); Search.ADMSave().click();
