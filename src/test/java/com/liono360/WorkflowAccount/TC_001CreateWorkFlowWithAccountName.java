...
public class TC_001CreateWorkFlowWithAccountName extends Baseclass {
	String wfname=null;
	
	@Test
	public void CreateWorkFlowWithAccount() throws Exception {
		// Create Workflow using Created with Account name
		redirectToCRM();
