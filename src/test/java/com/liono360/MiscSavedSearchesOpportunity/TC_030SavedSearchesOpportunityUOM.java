...
public class TC_030SavedSearchesOpportunityUOM extends Baseclass  {

	@Test
	public void SavedSearchesOpportunityUOMTest () throws InterruptedException {
		...
		logger.info("select on dropdown");
		 ...
		 Thread.sleep(5000); //explWaitToClick(account.Operator());
		  Search.UomSelectitem().click(); 
		  Thread.sleep(2000);
		  explWaitToClick(driver.findElement(By.xpath("//span[text()='Meter']")));
		  driver.findElement(By.xpath("//span[text()='Meter']")).click();
		  Search.UomSelectitem().click(); 
		  logger.info("select on dropdown");
...
//................................................4....................................................//	
		...
		Thread.sleep(5000);
		Search.Uom().click();
		logger.info("Clicked on Uom button");
