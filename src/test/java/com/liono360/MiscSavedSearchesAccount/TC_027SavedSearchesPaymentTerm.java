...
public class TC_027SavedSearchesPaymentTerm extends Baseclass {
	@Test
	public void SavedSearchesPaymentTermTest () throws InterruptedException, IOException {
		...
		driver.manage().timeouts().implicitlyWait(50,TimeUnit.SECONDS);
		  ...
		  explWaitToClick(Search.Name()); Search.Name().sendKeys("FName3k" +
		  ...
		  explWaitToClick(driver.findElement(By.xpath("//span[text()='Payment Term']"))
		  ); driver.findElement(By.xpath("//span[text()='Payment Term']")).click();
		  logger.info("select on dropdown");
		  ...
		  explWaitToClick(driver.findElement(By.
		  xpath("//span[text()=' Due on Receipt ']")));
		  driver.findElement(By.xpath("//span[text()=' Due on Receipt ']")).click();
	...
	//................................................4....................................................//	
			...
			Thread.sleep(5000);
			Search.PaymentTerm().click();
			logger.info("Clicked on PaymentTerm button");
	...
	//		logger.info("Clicked on Xcross button");
		 ...
		 */
		  ...
		  //..................................................// 
			 ...
			 * 
			 * Thread.sleep(3000); //explWaitToClick(account.Operator());
			 * Search.ADMFilter().click(); Thread.sleep(3000);
			 ...
			 * 
			 * 
			 * Thread.sleep(5000); Search.PaymentTerm().click();
			 * logger.info("Clicked on PaymentTerm button");
			 * 
			 * 
			 * Thread.sleep(5000); Search.SettingSave().click();
