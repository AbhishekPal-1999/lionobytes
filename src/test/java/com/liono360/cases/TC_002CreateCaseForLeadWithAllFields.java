...
// LOGIN TO CRM===============================================================================================
		 ...
		 //redirectToCRM();
			...
			SelectDropdown(cases.selectCaseAssociation(),2);
			...
			/*
			 * explWaitToClick(cases.setcontactNames());
			 * cases.setcontactNames().sendKeys("Kevin"+randomnumber());
			 * logger.info("Contact Name Added");
			 * 
			 * 
			 * 
			 * 
			 * explWaitToClick(cases.setEmailAddress());
			 * cases.setEmailAddress().sendKeys("case" + randomnumber() +
			 * "@lionobytes.com"); logger.info("Email for contact is added");
			 * 
			 * 
			 * explWaitToClick(cases.setPhoneNumber());
