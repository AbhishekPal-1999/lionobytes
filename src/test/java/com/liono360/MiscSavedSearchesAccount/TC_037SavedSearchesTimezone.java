...
public class TC_037SavedSearchesTimezone extends Baseclass{
	@Test
	public void SavedSearchesTimezoneTest () throws InterruptedException, IOException {
...
//.................................!!!!!!!!!!new1!!!!!!!!!!....................................................................//
		 ...
		 * explWaitToClick(driver.findElement(By.xpath("//span[text()='Sim Sale']")));
		 ...
		 * 
		 * 
		 * Thread.sleep(5000); Search.Simsale().click();
		 * logger.info("Clicked on Simsale button");
		 * 
		 * 
		 * 
		 * 
		 ...
		 * Search.Avalue1().click(); Thread.sleep(2000);
		 * explWaitToClick(driver.findElement(By.
		 * xpath("//span[text()=' (GMT-09:00) Alaska ']")));
		 * driver.findElement(By.xpath("//span[text()=' (GMT-09:00) Alaska ']")).click()
		 * ; logger.info("select on dropdown");
		 * 
		 * 
