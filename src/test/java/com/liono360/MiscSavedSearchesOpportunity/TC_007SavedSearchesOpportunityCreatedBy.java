...
public class TC_007SavedSearchesOpportunityCreatedBy extends Baseclass {

	@Test
	public void SavedSearchesOpportunityCreatedByTest () throws InterruptedException {
		//Shashank Trikha
		...
		Search.Name().sendKeys("HName2" + randomnumber());
