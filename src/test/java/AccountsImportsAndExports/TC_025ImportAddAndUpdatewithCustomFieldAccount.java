...
import ExcelWriteCodeImports.TC_006AddAndUpdateDataExcelFileOnAccount;

public class TC_025ImportAddAndUpdatewithCustomFieldAccount extends Baseclass {
	@Test
	public void ImportAddAndUpdatewithCustomFieldTest()
		...
		TryClick(account.AddUpdate());
		logger.info("Clicked on AddUpdate button");

		Thread.sleep(5000);
		TC_006AddAndUpdateDataExcelFileOnAccount Addupdate1 = new TC_006AddAndUpdateDataExcelFileOnAccount();
		Addupdate1.AddAndUpdateWithCustom();
		logger.info("Excel Data Write");

		Thread.sleep(4000);
		String filepath = System.getProperty("user.dir")
				+ "\\TestData\\Excel-Files-Accounts\\Account_AddAndUpdate Imports_With Custom Fileds 1.2.xlsx";
		Thread.sleep(5000);
