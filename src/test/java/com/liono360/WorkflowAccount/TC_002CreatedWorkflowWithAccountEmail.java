...
public class TC_002CreatedWorkflowWithAccountEmail extends Baseclass{
	String wfname=null;
	@Test
	public void CreatedWorkflowWithAccountEmail() throws Exception {
		...
		workflow.clickValueEnter().sendKeys("lionobytes" + randomnumber()+"@gmail.com");
		...
		createAccountEmail(acname);

		Thread.sleep(5000);
	}

	public void createAccountEmail(String accountemail) throws InterruptedException {
		WorkFlowPage workflow = new WorkFlowPage(driver);
		...
		workflow.clickGlobalSearch().sendKeys(accountemail);
		logger.info("click global search");
		Thread.sleep(6000);
