...
public class TC_029SavedSearchesStatus extends Baseclass{

	@Test
	public void SavedSearchesStatusTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Status']")));
		...
		Search.Value().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' Final ']")));
		driver.findElement(By.xpath("//span[text()=' Final ']")).click();
		Search.Value().click();
		logger.info("select on dropdown");
	...
	//................................................4....................................................//	
			...
			Thread.sleep(5000);
			Search.Satus().click();
			logger.info("Clicked on Satus button");
