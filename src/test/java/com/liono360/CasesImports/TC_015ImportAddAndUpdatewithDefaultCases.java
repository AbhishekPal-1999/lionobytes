...
public class TC_015ImportAddAndUpdatewithDefaultCases extends Baseclass {

@Test	
public void TC_015ImportAddAndUpdatewithDefaultCasesTest () throws InterruptedException, FileNotFoundException, IOException {
	...
	cases.AddUpdate().click();
	logger.info("Clicked on Updatec ");
	
	
	Thread.sleep(5000);
	ExcelWriteCodeImports.TC_013AddAndUpdateDataExcelFileCases addupdatecases = new ExcelWriteCodeImports.TC_013AddAndUpdateDataExcelFileCases ();
	addupdatecases.TryExcelFileWriteCodeTest();
	logger.info("Excel Data Write");
	
	
	Thread.sleep(4000);
	String filepath=System.getProperty("user.dir") + "\\TestData\\Excel-Files-Cases\\Case_AddAndUpdate Imports_With Default Fileds 1.1.xlsx";
	Thread.sleep(5000);
