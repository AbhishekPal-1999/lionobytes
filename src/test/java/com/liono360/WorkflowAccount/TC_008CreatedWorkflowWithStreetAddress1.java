...
public class TC_008CreatedWorkflowWithStreetAddress1 extends Baseclass{
	String wfname=null;

	@Test
	public void CreatedWorkflowWithStreetAddress1() throws InterruptedException {
		...
		workflow.clickStreetAddress1().click();
		Thread.sleep(2000);
		logger.info("click Select Filter");
		...
		workflow.clickValueEnter().sendKeys("11 Howard Street Manhattan");
		Thread.sleep(3000);
		logger.info("fill value enter");
	...
	public void createAccount(String account) throws InterruptedException {
        ...
        logger.info("click Address detail");
        Thread.sleep(1000);
        
        workflow.AdressDetailsIcon().click();
        logger.info("click Address detail icon");
        Thread.sleep(2000);
        ...
        workflow.StreetAdress1().click();
        logger.info("click street detail icon");
        Thread.sleep(1000);
        
        workflow.StreetAdress1().sendKeys(account);
        logger.info("fill street detail icon");
        Thread.sleep(1000);
