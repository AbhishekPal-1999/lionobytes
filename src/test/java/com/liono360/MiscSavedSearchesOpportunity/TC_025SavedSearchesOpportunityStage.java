...
public class TC_025SavedSearchesOpportunityStage extends Baseclass{

	@Test
	public void SavedSearchesOpportunityStageTest () throws InterruptedException {
		...
		logger.info("select on dropdown");
		 ...
		 Thread.sleep(5000); //explWaitToClick(account.Operator());
		  ...
		  Thread.sleep(2000);
		  explWaitToClick(driver.findElement(By.xpath("//span[text()=' Investigation ']")));
		  driver.findElement(By.xpath("//span[text()=' Investigation ']")).click();
		  Search.Avalue1().click(); 
		  logger.info("select on dropdown");
