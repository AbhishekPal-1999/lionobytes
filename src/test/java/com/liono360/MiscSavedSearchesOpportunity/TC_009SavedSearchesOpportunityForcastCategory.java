...
public class TC_009SavedSearchesOpportunityForcastCategory extends Baseclass{

	@Test
	public void SavedSearchesOpportunityForcastCategoryTest () throws InterruptedException {
		...
		Search.Value().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()=' Closed Won ']")));
		driver.findElement(By.xpath("//span[text()=' Closed Won ']")).click();
		Search.Value().click();
		logger.info("select on dropdown");
