...
public class TC_013SavedSearchesIndustry extends Baseclass {

	@Test
	public void SavedSearchesIndustryTest () throws InterruptedException {
		driver.get(baseURL);
		...
		Search.Name().sendKeys("FNamef4" + randomnumber());
		...
		Search.Value().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='  Food & Beverages ']")));
		driver.findElement(By.xpath("//span[text()='  Food & Beverages ']")).click();
		Search.Value().click();
		logger.info("select on dropdown");
