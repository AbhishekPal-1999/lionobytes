...
public class TC_018SavedSearchesOpportunityPrice extends Baseclass{

	@Test
	public void SavedSearchesOpportunityPriceTest () throws InterruptedException {
		...
		Search.Filter().click();
		Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("//span[text()='Price']")));
