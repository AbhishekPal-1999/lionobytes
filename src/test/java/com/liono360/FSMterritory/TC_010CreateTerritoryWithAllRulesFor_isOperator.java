...
public class TC_010CreateTerritoryWithAllRulesFor_isOperator extends Baseclass {

	@Test
	public void TC_010CreateTerritoryWithAllRulesFor_IsOperator() throws IOException, InterruptedException {
...
for(int i=1;i<=2;i++) {
		...
		territory.setTerritoryName().sendKeys("NewYork"+randomnumber());
