...
public class TC_019CreatedWithManualWithSavedSearchWf extends Baseclass {
	String wfname=null;
	@Test
	public void CreatedWithManualWithSavedSearchWf() throws InterruptedException {
		redirectToCRM();
	...
	//	workflow.clicktriggertime2().click();
		driver.findElement(By.xpath("//span[text()='Days']")).click();
		Thread.sleep(1000);
	...
	//	Thread.sleep(3000);
		...
		workflow.AccountName().sendKeys(AccountName);
	...
	//	Thread.sleep(4000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//input[@type='text'])[27]")).sendKeys("1"+randomnumber());
		Thread.sleep(1000);
