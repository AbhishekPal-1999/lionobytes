...
public class TC_016CreatedWorkflowEEAccountNo  extends Baseclass{
	String wfname=null;

	@Test
	public void CreatedWorkflowEEAccountNo() throws InterruptedException {
	 redirectToCRM();
	 WorkFlowPage workflow = new WorkFlowPage(driver);
		...
		workflow.clickAccounts().click(); Thread.sleep(5000);
