...
public class TC_016CreateAccountTerritoryWithParentTerritory extends Baseclass {
	
	@Test
	public void TC_016CreateAccountsTerritoryWithParentTerritory() throws InterruptedException, IOException
	{
		// LOGIN TO CRM=======================================================
...
// GO TO TERRITORY PAGE================================================
		...
		//Thread.sleep(2000);
		explWaitToClick(driver.findElement(By.xpath("(//ul)[6]//p-treenode[4]")));
		driver.findElement(By.xpath("(//ul)[6]//p-treenode[4]")).click();
