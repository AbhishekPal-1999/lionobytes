...
public class TC_014FileUploadTypeQuestion extends Baseclass  {

	@Test
	public void TC_014FileUploadTypeQuestionTest() throws InterruptedException, IOException, TimeoutException {
	    ...
	    Q.setQuestionName().sendKeys("upload file for this Question"+randomnumber());
	    String QuestionName=Q.setQuestionName().getAttribute("value");
	    logger.info("question name added");
	    
	    TryClick(Q.selectAnswerType());
	    driver.findElement(By.xpath("//span[text()='FileUpload']")).click();                            
