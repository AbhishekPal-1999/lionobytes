...
public class TC_014SavedSearchesOpportunityOpportunityName extends Baseclass{

	@Test
	public void SavedSearchesOpportunityOpportunityNameTest () throws InterruptedException {
		...
		Search.Name().sendKeys("N0ameu7" + randomnumber());
