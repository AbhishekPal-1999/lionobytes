...
public class TC_021SavedSearchesOpportunityQuality extends Baseclass{
	@Test
	public void SavedSearchesOpportunityQualityTest () throws InterruptedException {
		...
		Search.Name().sendKeys("JName7" + randomnumber());
...
//................................................4....................................................//	
		...
		Thread.sleep(5000);
		Search.Quality().click();
		logger.info("Clicked on Quality button");
		 ...
		 * explWaitToClick(driver.findElement(By.xpath("//span[text()='UOM']")));
		 * driver.findElement(By.xpath("//span[text()='UOM']")).click();
		 * logger.info("select on dropdown");
		 * 
		 * 
