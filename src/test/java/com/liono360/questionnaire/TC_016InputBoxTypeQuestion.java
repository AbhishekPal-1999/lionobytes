...
public class TC_016InputBoxTypeQuestion extends Baseclass  {
	...
	//	redirectToCRM();
	    ...
	    Q.setQuestionName().sendKeys("enter your answer for Question"+randomnumber());
	    String QuestionName=Q.setQuestionName().getAttribute("value");
	    logger.info("question name added");
	    
	    TryClick(Q.selectAnswerType());
	    driver.findElement(By.xpath("//span[text()='InputBox']")).click();                            
