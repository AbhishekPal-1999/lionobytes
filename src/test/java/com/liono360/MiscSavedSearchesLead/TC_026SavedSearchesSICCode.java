...
public class TC_026SavedSearchesSICCode extends Baseclass{

	@Test
	public void SavedSearchesSICCodeTest () throws InterruptedException {
		...
		Search.Name().sendKeys("FName8u" + randomnumber());
		...
		Thread.sleep(3000);
		//explWaitToClick(account.Value());
		Search.Value1().sendKeys("11111111");
