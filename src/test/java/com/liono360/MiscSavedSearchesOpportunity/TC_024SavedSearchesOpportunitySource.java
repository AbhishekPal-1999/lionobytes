...
public class TC_024SavedSearchesOpportunitySource extends Baseclass {

	@Test
	public void SavedSearchesOpportunitySourceTest () throws InterruptedException {
		...
		Search.Name().sendKeys("OName2" + randomnumber());
		...
		logger.info("select on dropdown");
		 ...
		 Thread.sleep(5000); //explWaitToClick(account.Operator());
		  ...
		  Thread.sleep(2000);
		  explWaitToClick(driver.findElement(By.xpath("//span[text()=' Broker Referral ']")));
		  driver.findElement(By.xpath("//span[text()=' Broker Referral ']")).click();
		  Search.Avalue1().click(); 
		  logger.info("select on dropdown");
