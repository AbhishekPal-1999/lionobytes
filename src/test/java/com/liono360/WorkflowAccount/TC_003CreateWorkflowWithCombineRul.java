...
public class TC_003CreateWorkflowWithCombineRul extends Baseclass {
	String wfname = null;

	@Test

	public void CreateWorkflowWithCombineRul() throws InterruptedException {
		redirectToCRM();
		...
		workflow.clickWorkflowName().sendKeys("WorkFlow194" + randomnumber());
	//	Thread.sleep(2000);
	...
	//	Thread.sleep(4000);
		...
		/* * workflow.clickSelectFilter().click(); Thread.sleep(2000);
		 * logger.info("click Select Filter");
		 * 
		 * workflow.clickAccountName().click(); Thread.sleep(2000);
		 * logger.info("click Select Filter"); workflow.clickSelectOperator().click();
		 * Thread.sleep(2000); logger.info("click Select operator");
		 * 
		 * workflow.clickOperatorOptionIsEqual().click(); Thread.sleep(2000);
		 * logger.info("click IsEqual operator");
		 * 
		 * workflow.clickValueEnter().click(); Thread.sleep(2000);
		 * logger.info("click Value Enter");
		 * workflow.clickValueEnter().sendKeys("WorkFlowTestAutomation" +
		 * randomnumber()); Thread.sleep(1000); logger.info("fill Value"); String
		 * acname=workflow.clickValueEnter().getAttribute("value");
		 * 
		 * 
		 * 
		 * workflow.clickAddRuleManual().click(); Thread.sleep(1000);
		*/ 
		// logger.info("add one value");
		 String acname=workflow.clickValueEnter().getAttribute("value");
		 String AccountEmailname=null;
		 String Accountname=null;
		 String AccountNumber=null; 
		 String AccountPhoneNo=null;
		...
		for (int i = 1; i <=5; i++) {
			...
			driver.findElement(By.xpath("(//p-dropdown[@id='ruleFilter'])[" + i + "]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("(//p-dropdownitem//li[@role='option'])[" + (4 + i) + "]")).click();
			
			Thread.sleep(1000);
			if (i == 1) {
				driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]")).click();

				driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))
						.sendKeys("WorkFlowTest" + randomnumber() + "@gmail.com");
				 AccountEmailname=(driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))).getAttribute("value");
			...
			if(i==2) {
				...
				driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))
						.sendKeys("WorkFlowTest"+randomnumber());
				
				Accountname= (driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))).getAttribute("value");
			...
			if(i==3) {
				...
				driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))
						.sendKeys("230987654"+randomnumber());
				AccountNumber=(driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))).getAttribute("value");
			...
			if(i==4) {
				...
				driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))
						.sendKeys("9867542"+randomnumber());
				AccountPhoneNo= (driver.findElement(By.xpath("(//input[@placeholder='Enter'])[" + i + "]"))).getAttribute("value");
			...
			if(i==5) {
				...
				Thread.sleep(1000);
				driver.findElement(By.xpath("(//p-multiselectitem//li)[3]")).click();
				Thread.sleep(1000);
				logger.info("fill item value");
			}
	...
	//		Thread.sleep(3000);
		...
		//	Thread.sleep(3000);
			...
			createAccount(acname,AccountEmailname,Accountname,AccountNumber,AccountPhoneNo);
			
		}
		//Create Account
		public void createAccount(String account,String email,String Accountnames,String acnumber,String AccountPhoneNo) throws InterruptedException {
			WorkFlowPage workflow = new WorkFlowPage(driver);
