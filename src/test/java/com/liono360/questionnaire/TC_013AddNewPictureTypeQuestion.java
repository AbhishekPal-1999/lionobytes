...
public class TC_013AddNewPictureTypeQuestion extends Baseclass  {

	@Test
	public void TC_013AddNewPictureTypeQuestionTest() throws InterruptedException, IOException, TimeoutException {
	...
	//	redirectToCRM();
	    ...
	    Q.setQuestionName().sendKeys("upload picture for this Question"+randomnumber());
	    String QuestionName=Q.setQuestionName().getAttribute("value");
	    logger.info("question name added");
	    
	   TryClick( Q.selectAnswerType());
	    driver.findElement(By.xpath("//span[text()='Picture']")).click();                            
